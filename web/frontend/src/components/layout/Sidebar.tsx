...
export function Sidebar() {
  return (
    <aside className="flex flex-col w-[220px] shrink-0 border-r border-white/10 bg-gray-900/60 backdrop-blur-sm">
      {/* Logo */}
      ...
      <div className="px-5 py-3 border-t border-white/10">
        <p className="text-[10px] text-gray-600">GNN Explainability Framework</p>
      </div>
    </aside>
  )
}
